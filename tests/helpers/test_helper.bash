...
helper_setup() {
    ...
    # Disable the optional audit store by default so the presence of the sqlite3
    # stub on PATH does not alter unrelated launch/stop tests. The audit test
    # suite re-enables it explicitly.
    export SOCAT_MANAGER_AUDIT=0
